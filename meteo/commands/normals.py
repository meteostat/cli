"""Climate normals command for the Meteostat CLI."""
...
def _normals(
    ...
    start: str | None = typer.Option(None, "--start", "-s", help="Start year (YYYY)."),
    end: str | None = typer.Option(None, "--end", "-e", help="End year (YYYY)."),
...
normals_cmd = _normals
normals_cmd_alias = _normals
