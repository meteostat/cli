"""Hourly time series command for the Meteostat CLI."""
...
def _hourly(
    ...
    start: str | None = typer.Option(
        ...
        "--start",
        "-s",
        help="Start date (YYYY-MM-DD, YYYY-MM, YYYY, or ISO 8601).",
    ),
    end: str | None = typer.Option(None, "--end", "-e", help="End date."),
    timezone: str | None = typer.Option(
        None, "--timezone", "-t", help="Timezone for output timestamps."
    ),
